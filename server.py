...
def match_rooms_to_polygons(dxf_path: str) -> str:
    ...
    """
    from parsers.room_matcher import match_rooms_json
    result = match_rooms_json(dxf_path)
    result["sonraki_adim"] = "draw_room_markers() ile GstarCAD'e hatch + etiket çizin"
    return json.dumps(result, ensure_ascii=False, indent=2)
